...
full_path = 'S:/Applications/Coding/Projects/Machine Learning/Kaggle/prudential-life-insurance-assessment/ST694-Project/Files/data_final/train_clean_binary.csv'
...
print("Accuracy:",accuracy_score(df_test_Y, my_pred))
print("Precision:",precision_score(df_test_Y, my_pred))
print("Recall:",recall_score(df_test_Y, my_pred))
